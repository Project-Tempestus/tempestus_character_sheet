...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', required=False, type=str, help='Output directory', default="../rst/")
    ...
    outputRST = os.path.join(outputDir,"items.rst")

    # build_file(outputRST, filesDict,"digraph.j2","rst.j2")
    build_file(outputRST, filesDict,"csvtable.j2","rst.j2")
